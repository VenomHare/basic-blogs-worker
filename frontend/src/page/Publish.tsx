...
import { createBlogTypes } from "@sarthak00dev/mediumtypes"
...
const Publish = () => {
    ...
    const onSubmit = async (e:React.FormEvent) => {
        ...
        try {
            ...
            const reqBody : createBlogTypes = {
                title,
                content
            }
            
            const req = await axios.post(`${BACKEND_URL}/api/v1/blog`,reqBody,{
                headers: {
        ...
        <div className="flex flex-col items-center overflow-x-clip">
            ...
            <div className="mb-6 w-[80%] mt-3">
                <form onSubmit={onSubmit}>
                    ...
                    <input type="text" id="large-input" onChange={(e)=>setTitle(e.target.value)} className="block w-full p-4 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 text-base focus:ring-blue-500 focus:border-blue-500" />
                    ...
                    <div className="w-full mb-4 border border-gray-200 rounded-lg bg-gray-50 ">
                        ...
                        <div className="px-4 py-2 bg-white rounded-b-lg ">
                            ...
                            <textarea id="editor" onChange={(e)=>setContent(e.target.value)} rows={8} className="block w-full px-0 text-sm text-gray-800 bg-white border-0 " placeholder="Write an article..." required ></textarea>
                        </div>
                    </div>
